function compute_cortical_area
% Calculates the total surface area of the New York Head model with balls of
% increasing radii, centered at N randomly chosen vertices. This function is
% designed to be run by compute_cortical_area.sh
