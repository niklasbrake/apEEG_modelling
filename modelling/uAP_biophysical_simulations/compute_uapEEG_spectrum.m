function compute_uapEEG_spectrum
% COMPUTE_UAPEEG_SPECTRUM computes and saves the spectrum of the unitary apEEG responses
%   of all the neuron simulations. Called by compute_uAP_spectrum.sh.

    parpool(10);

    % Load results of compute_uAP
    ...
    % Compute the EEG signal for each uAP response at all the source location
    % of the NY head model, compute the spectrum, and average together
    psd = zeros(n/2,m);
    parfor j = 1:m
