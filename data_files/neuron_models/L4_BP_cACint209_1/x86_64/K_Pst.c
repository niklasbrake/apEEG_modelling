...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_Pst /lustre04/scratch/nbrake/data/simulations/unitary_AP/L4_BP_cACint209_1/mechanisms/K_Pst.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/lustre04/scratch/nbrake/data/simulations/unitary_AP/L4_BP_cACint209_1/mechanisms/K_Pst.mod";
static const char* nmodl_file_text = 
